...
import { LineaPunteada } from './TituloSeccion'
const NOMBRE = "Juan Fernando Ríos"
const OFICIO = "Desarrollador Frontend"
const DESCRIPCION = "Soy una persona seria, responsable y dinámica, con facilidad de adaptación. Disfruto del  constante aprendizaje y exploración de nuevas tecnologías. Busco crecer profesionalmente, aplicar y adquirir conocimientos."
...
const ItemInformacion = ({ titulo, texto }) => {
    return (
        <div className="flex lg:flex-col lg:text-center">
            <p className="uppercase text-white text-xs md:text-lg lg:text-sm">{titulo}:</p>
            <p className="uppercase text-AzulNormal text-xs pl-1 md:text-lg lg:text-sm"> {texto}</p>
        </div>
