        ...
        <div className="bg-AzulMedio py-5 px-2 m-1 rounded-t-3xl">
            <div className="flex items-center">
                ...
                <div className="ml-1">
                    ...
                    <p className="text-justify text-white font-thin leading-none pt-2 text-sm">Soy una persona seria, responsable y dinámica, con facilidad de adaptación. Disfruto del  constante aprendizaje y exploración de nuevas tecnologías. Busco crecer profesionalmente, aplicar y adquirir conocimientos.</p>
                </div>
            </div>
            <div className="pt-2 flex flex-col">
                ...
                <div className="flex justify-between pt-2">
                    <ItemInformacion titulo="dirección" texto="cRA SANTANDER #20-104, cONCEPCIÓN aNTIOQUIA"/>
                </div>
            </div>
        </div>
    )
...
const ItemInformacion = ({ titulo, texto }) => {
    return (
        <div className="flex">
            ...
            <p className="uppercase text-AzulNormal text-xs"> {texto}</p>
        </div>
